...
1. **Agent 1: The Assessor (Vision AI)** - Examines the image uploaded by the citizen to classify the issue and severity in structured JSON.
2. **Agent 2: The Router (Workflow Automation)** - Takes the Assessor's JSON and determines the target municipal department, drafting a maintenance ticket.
3. **Agent 3: The Analyst (Predictive Insights)** - Scans all Firestore reports to identify patterns and predict hotspots.

Refer to the [docs/](file:///d:/Hackathon_Projects/CivicFlow/docs/) directory for detailed architecture and project definitions.
